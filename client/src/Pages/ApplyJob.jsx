      ...
      <div className='bg-white text-black rounded-lg w-full'>
       <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
        ...
        <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
          <button onClick={applyHandler} className='bg-blue-600 text-white px-10 p-2 rounded'>
       ...
       <div className='flex flex-col lg:flex-row justify-between items-start '>
        <div className='w-full lg:w-2/3'>
          <h2 className='font-bold text-2xl mb-4'>Job Description</h2>
            ...
            <button onClick={applyHandler} className='bg-blue-600 text-white px-10 p-2 rounded mt-10'>
              {isAlreadyApplied? "Already Applied": "Apply Now"}
              </button>
        </div>
        ...
        <div className='w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5'>
          ...
          .filter(job => {
            // set of already applied jobs ids
            const appliedJobIds = new Set(userApplications.map(app => app.jobId && app.jobId._id));
            // return true if job id is not in appliedJobIds
